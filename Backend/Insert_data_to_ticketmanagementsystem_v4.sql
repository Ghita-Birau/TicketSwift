INSERT INTO ticketmanagementsystem_v4.user(user_email, user_name, address, date_of_birth, first_name, gender, password, second_name) VALUES
...
INSERT INTO ticketmanagementsystem_v4.role(role_description, user_id) VALUES
	('ADMIN', 1),
	('USER', 2),
	('USER', 3);

INSERT INTO ticketmanagementsystem_v4.order_entity (number_of_tickets, ordered_at, total_price, event_ticket_category_id, user_id) VALUES
...
INSERT INTO ticketmanagementsystem_v4.event_type (event_type_name) VALUES
	('Festival de Muzica'),
	('Sport'),
	('Bauturi'),
    ('Dans'),
...
INSERT INTO ticketmanagementsystem_v4.venue (capacity, location, type, longitude, latitude) VALUES
...
INSERT INTO ticketmanagementsystem_v4.event (end_date, event_description, event_name, start_date, event_type_id, venue_id, url_image) VALUES
...
INSERT INTO ticketmanagementsystem_v4.ticket_category (description) VALUES
	('Standard'),
	('VIP'),
	('Early Bird'),
	('Last Minute'),
...
INSERT INTO ticketmanagementsystem_v4.event_ticket_category (price, event_id, access, avaible_quantity, discount_percentage, ticket_category_id) VALUES
